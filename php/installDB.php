...
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (2, date('2023-06-01'))";
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (5, date('2023-06-01'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (1, date('2023-06-01'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (7, date('2023-06-02'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (3, date('2023-06-02'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (4, date('2023-06-02'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (3, date('2023-06-03'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (1, date('2023-06-03'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (5, date('2023-06-03'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (6, date('2023-06-04'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (7, date('2023-06-04'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (8, date('2023-06-04'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (2, date('2023-06-05'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (4, date('2023-06-05'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (3, date('2023-06-05'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (7, date('2023-06-06'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (5, date('2023-06-06'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (1, date('2023-06-06'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (6, date('2023-06-07'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (4, date('2023-06-07'))";
    mysqli_query($conn, $create_order);
}
...
$result = mysqli_query($conn, $order_created_query);
if (mysqli_num_rows($result) == 0) {
    $create_order = "INSERT INTO orders (Customer_ID, Date) VALUES (3, date('2023-06-07'))";
    mysqli_query($conn, $create_order);
}
